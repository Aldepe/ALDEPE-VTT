...
export function createDefaultAction(characterId: ID): CharacterAction {
  ...
  return {
    ...
    actionCost: 'action',
    range: 'Self / touch',
    description: 'Interactua con un objeto importante del encuentro.',
...
export function createDefaultTrigger(): CharacterTrigger {
  return {
    ...
    appliesWhen: 'Cuando una condicion, posicion o ayuda cambie la tirada.',
    summary: 'Tira dos d20 y usa el mejor o peor resultado segun el caso.',
    active: false,
...
export function createDefaultFeature(): CharacterFeature {
  return {
    ...
    currentUses: 1,
    recovery: 'shortRest',
    summary: 'Recupera energia en mitad del combate.',
    beginnerHint: 'Recuerdalo cuando estes herido y aun tengas tu Bonus Action.',
    mechanicalEffect: 'Configurable: curacion o recurso segun clase.',
...
export function createDefaultSpell(): CharacterSpell {
  return {
    ...
    summary: 'Ataque magico editable de ejemplo. No contiene texto oficial.',
    ...
    usageExamples: ['Usalo cuando necesitas dano seguro a distancia.', 'Usalo para rematar un objetivo debilitado.'],
